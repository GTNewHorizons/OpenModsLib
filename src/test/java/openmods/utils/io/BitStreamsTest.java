...
public class BitStreamsTest {
    ...
    public static void writeBits(OutputBitStream stream, boolean... bits) throws IOException {
        for (boolean bit : bits) stream.writeBit(bit);
    }
    ...
    public static void checkInputOutput(int size, boolean[] bits) throws IOException {
        ...
        for (boolean bit : bits) outputStream.writeBit(bit);
    ...
    public void testInputStreamOneByteAllOnes() throws IOException {
        ...
        checkInputStream(inputStream, true, true, true, true, true, true, true, true);
    }
    ...
    public void testInputStreamOneByteToggling() throws IOException {
        ...
        checkInputStream(inputStream, false, true, false, true, false, true, false, true);
    }
    ...
    public void testInputStreamOneByteFirstOne() throws IOException {
        ...
        checkInputStream(inputStream, true, false, false, false, false, false, false, false);
    }
    ...
    public void testInputStreamOneByteLastOne() throws IOException {
        ...
        checkInputStream(inputStream, false, false, false, false, false, false, false, true);
    }
    ...
    public void testInputOutput() throws IOException {
        ...
        checkInputOutput(
                2,
                new boolean[] { true, false, true, false, true, false, true, false, false, true, false, true });

        checkInputOutput(
                2,
                new boolean[] { true, true, true, true, true, true, true, true, false, false, false, false, false,
                        false, false, false });
    }
}
