...
public class OrientationTest {
    ...
    public void testFourSameRotations() {
        for (Orientation o : Orientation.VALUES) for (HalfAxis a : HalfAxis.VALUES) {
    ...
    public void testRotationAroundX() {
        for (Orientation o : Orientation.VALUES) for (HalfAxis a : select(HalfAxis.POS_X, HalfAxis.NEG_X)) {
    ...
    public void testRotationY() {
        for (Orientation o : Orientation.VALUES) for (HalfAxis a : select(HalfAxis.POS_Y, HalfAxis.NEG_Y)) {
            final Orientation r = o.rotateAround(a).rotateAround(a);
    ...
    public void testRotationZ() {
        for (Orientation o : Orientation.VALUES) for (HalfAxis a : select(HalfAxis.POS_Z, HalfAxis.NEG_Z)) {
            final Orientation r = o.rotateAround(a).rotateAround(a);
            Assert.assertEquals(o.x.negate(), r.x);
            Assert.assertEquals(o.y.negate(), r.y);
    ...
    public void testTwoRotations() {
        for (Orientation o : Orientation.VALUES) {
            testSameRotations(
                    o,
                    pair(HalfAxis.NEG_Z, HalfAxis.POS_X),
                    pair(HalfAxis.POS_Y, HalfAxis.NEG_Z),
                    pair(HalfAxis.POS_X, HalfAxis.POS_Y));
            testSameRotations(
                    o,
                    pair(HalfAxis.POS_Z, HalfAxis.POS_X),
                    pair(HalfAxis.POS_X, HalfAxis.NEG_Y),
                    pair(HalfAxis.NEG_Y, HalfAxis.POS_Z));
            testSameRotations(
                    o,
                    pair(HalfAxis.POS_Z, HalfAxis.NEG_X),
                    pair(HalfAxis.POS_Y, HalfAxis.POS_Z),
                    pair(HalfAxis.NEG_X, HalfAxis.POS_Y));
            testSameRotations(
                    o,
                    pair(HalfAxis.NEG_Z, HalfAxis.NEG_X),
                    pair(HalfAxis.NEG_Y, HalfAxis.NEG_Z),
                    pair(HalfAxis.NEG_X, HalfAxis.NEG_Y));
            testSameRotations(
                    o,
                    pair(HalfAxis.POS_X, HalfAxis.POS_Z),
                    pair(HalfAxis.POS_Z, HalfAxis.POS_Y),
                    pair(HalfAxis.POS_Y, HalfAxis.POS_X));
            testSameRotations(
                    o,
                    pair(HalfAxis.POS_X, HalfAxis.NEG_Z),
                    pair(HalfAxis.NEG_Z, HalfAxis.NEG_Y),
                    pair(HalfAxis.NEG_Y, HalfAxis.POS_X));
            testSameRotations(
                    o,
                    pair(HalfAxis.NEG_X, HalfAxis.POS_Z),
                    pair(HalfAxis.POS_Z, HalfAxis.NEG_Y),
                    pair(HalfAxis.NEG_Y, HalfAxis.NEG_X));
            testSameRotations(
                    o,
                    pair(HalfAxis.NEG_X, HalfAxis.NEG_Z),
                    pair(HalfAxis.POS_Y, HalfAxis.NEG_X),
                    pair(HalfAxis.NEG_Z, HalfAxis.POS_Y));
        }
    }
    ...
    public static void main(String[] argv) {
        ...
        for (HalfAxis a : HalfAxis.VALUES) for (HalfAxis b : HalfAxis.VALUES) {
