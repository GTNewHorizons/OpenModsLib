...
public class FunctionTypesTest {
    ...
    public void testFunction3() {
        ...
        Assert.assertArrayEquals(
                wrap(Integer.class, Long.class, String.class),
                MethodAccess.resolveParameterTypes(F.class));
    }
    ...
    public void testFunction4() {
        ...
        Assert.assertArrayEquals(
                wrap(Double.class, Integer.class, Boolean.class, Character.class),
                MethodAccess.resolveParameterTypes(F.class));
    }
    ...
    public void testFunction5() {
        ...
        Assert.assertArrayEquals(
                wrap(Integer.class, Double.class, Long.class, Float.class, Boolean.class),
                MethodAccess.resolveParameterTypes(F.class));
    }
