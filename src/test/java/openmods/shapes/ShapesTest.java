...
public class ShapesTest {
    ...
    public static Multiset<Coord> generate(IShapeGenerator generator, int minX, int minY, int minZ, int maxX, int maxY,
            int maxZ) {
    ...
    public static BoundingBox bb(Collection<Coord> coords) {
        ...
        for (Coord coord : coords) bb.addCoord(coord);
        return bb;
    }

    public static BoundingBox bb(IShapeGenerator generator, int minX, int minY, int minZ, int maxX, int maxY,
            int maxZ) {
        final Multiset<Coord> coords = generate(generator, minX, minY, minZ, maxX, maxY, maxZ);
        return bb(coords);
    }

    public static void checkInBB(IShapeGenerator generator, int minX, int minY, int minZ, int maxX, int maxY,
            int maxZ) {
