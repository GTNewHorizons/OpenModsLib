...
public class SerializableTest {
    ...
    public static class TestGenericMap {
        ...
        {
            for (int i = 0; i < 11; i++) nonNull.put("aaaa" + i, (i & 2) == 0);
        }
...

        {
            ...
            for (int i = 0; i < 11; i++) nulls.put(99.0f + i, (i & 4) == 0 ? null : "aaa");
        ...
        @FieldTest
        public Map<String, MultipleClassEnum> enums = ImmutableMap
                .of("fff", MultipleClassEnum.A, "bbb", MultipleClassEnum.C);
