...
public class FractionCalculatorTest {
    ...
    public void testConstantEvaluatingBrackets() {
        final SymbolStub<Fraction> stub = new SymbolStub<Fraction>().allowCalls().expectArgs(f(1), f(2))
                .verifyArgCount().setReturns(f(5), f(6), f(7)).verifyReturnCount();
    ...
    public void testNestedConstantEvaluatingBrackets() {
        final SymbolStub<Fraction> stub = new SymbolStub<Fraction>().allowGets().setGetValue(f(5));
        sut.environment.setGlobalSymbol("dummy", stub);
    ...
    public void testConstantEvaluatingSymbol() {
        final SymbolStub<Fraction> stub = new SymbolStub<Fraction>().allowCalls().expectArgs(f(1), f(2))
                .verifyArgCount().setReturns(f(5)).verifyReturnCount();
        sut.environment.setGlobalSymbol("dummy", stub);
