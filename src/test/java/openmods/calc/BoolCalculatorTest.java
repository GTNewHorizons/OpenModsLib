...
public class BoolCalculatorTest {
    ...
    public void testConstantEvaluatingBrackets() {
        final SymbolStub<Boolean> stub = new SymbolStub<Boolean>().allowCalls().expectArgs(true, false).verifyArgCount()
                .setReturns(false, false, true).verifyReturnCount();
    ...
    public void testConstantEvaluatingSymbol() {
        final SymbolStub<Boolean> stub = new SymbolStub<Boolean>().allowCalls().expectArgs(false, true).verifyArgCount()
                .setReturns(true).verifyReturnCount();
        sut.environment.setGlobalSymbol("dummy", stub);
