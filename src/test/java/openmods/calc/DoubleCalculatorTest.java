...
public class DoubleCalculatorTest {
    ...
    public void testConstantEvaluatingBrackets() {
        final SymbolStub<Double> stub = new SymbolStub<Double>().allowCalls().expectArgs(1.0, 2.0).verifyArgCount()
                .setReturns(5.0, 6.0, 7.0).verifyReturnCount();
    ...
    public void testNestedConstantEvaluatingBrackets() {
        final SymbolStub<Double> stub = new SymbolStub<Double>().allowGets().setGetValue(5.0);
        sut.environment.setGlobalSymbol("dummy", stub);
    ...
    public void testConstantEvaluatingSymbol() {
        final SymbolStub<Double> stub = new SymbolStub<Double>().allowCalls().expectArgs(1.0, 2.0).verifyArgCount()
                .setReturns(5.0).verifyReturnCount();
        sut.environment.setGlobalSymbol("dummy", stub);
