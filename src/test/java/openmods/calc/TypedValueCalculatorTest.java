...
public class TypedValueCalculatorTest {
    ...
    private TypedValue list(TypedValue... values) {
        TypedValue res = nil();
        for (int i = values.length - 1; i >= 0; i--) res = domain.create(Cons.class, new Cons(values[i], res));
    ...
    public void testTruthyCompositeObjects() {
        ...
        sut.environment.setGlobalSymbol(
                "trueComposite",
                domain.create(
                        DummyObject.class,
                        DUMMY,
    ...
    public void testCountableComposite() {
        ...
        sut.environment.setGlobalSymbol(
                "zeroLength",
                domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new LengthSlot(0)).build()));

        infix("len(zeroLength)").expectResult(i(0));

        sut.environment.setGlobalSymbol(
                "nonZeroLength",
                domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new LengthSlot(5)).build()));
    ...
    public void testEquatableComposite() {
        ...
        sut.environment.setGlobalSymbol(
                "equalsTo5",
                domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new EqualsSlot(i(5))).build()));
    ...
    public void testCallableComposite() {
        class CallableSlot implements MetaObject.SlotCall {
            ...
            public void call(TypedValue self, OptionalInt argumentsCount, OptionalInt returnsCount,
                ...
                for (int i = 0; i < argumentsCount.get(); i++) frame.stack().pop();
        ...
        sut.environment.setGlobalSymbol(
                "test",
                domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new CallableSlot()).build()));
        ...
        public Optional<TypedValue> attr(TypedValue self, String key, Frame<TypedValue> frame) {
            if (key.equals("path")) return Optional.of(domain.create(String.class, Joiner.on("/").join(path)));
                    ...
                    domain.create(
                            DummyObject.class,
                            DUMMY,
                            MetaObject.builder().set(new TestStructuredComposite(prefix, path, key)).build()));
        }
    }
    ...
    private class CallableLoggerStruct implements MetaObject.SlotAttr {
        ...
        public Optional<TypedValue> attr(TypedValue self, final String key, Frame<TypedValue> frame) {
            return Optional
                    .of(domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new MetaObject.SlotCall() {
                        ...
                        public void call(TypedValue self, OptionalInt argumentsCount, OptionalInt returnsCount,
                            ...
                            for (TypedValue v : substack) result.add(v.as(String.class));
                            substack.clear();
    ...
    private void testCustomSymbolCall(String symbol) {
        sut.environment.setGlobalSymbol(
                "test",
                domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new CallableLoggerStruct()).build()));
    ...
    public void testDotOperatorWithCustomExprSymbolCall() {
        ...
        // following symbols have custom state transition and symbol, but it works with dot as long as it extends
        // SymbolCallNode
                                    ...
                                    .set(MetaObjectUtils.callableAdapter(new UnaryFunction.Direct<TypedValue>() {
                                        ...
                                        protected TypedValue call(TypedValue value) {
                                            ...
                                            class InnerAttrSlot implements MetaObject.SlotAttr {
                                                ...
                                                @Override
                                                public Optional<TypedValue> attr(TypedValue self, String key,
                                                        Frame<TypedValue> frame) {
    ...
    public void testIndexableComposite() {
        ...
        final TypedValue test = domain
                .create(DummyObject.class, DUMMY, MetaObject.builder().set(new TestIndexableComposite()).build());
    ...
    public void testConstantEvaluatingBrackets() {
        final SymbolStub<TypedValue> stub = new SymbolStub<TypedValue>().allowCalls().expectArgs(i(1), i(2))
                .verifyArgCount().setReturns(i(5), i(6), i(7)).verifyReturnCount();
    ...
    public void testNestedConstantEvaluatingBrackets() {
        final SymbolStub<TypedValue> stub = new SymbolStub<TypedValue>().allowGets().setGetValue(i(5));
        sut.environment.setGlobalSymbol("dummy", stub);
    ...
    public void testConstantEvaluatingSymbol() {
        final SymbolStub<TypedValue> stub = new SymbolStub<TypedValue>().allowCalls().expectArgs(i(1), i(2))
                .verifyArgCount().setReturns(i(5)).verifyReturnCount();
        sut.environment.setGlobalSymbol("dummy", stub);
    ...
    public void testLetCompilationShortcut() {
        ...
        infix("let([x:y = 1:2], x + y)")
                .expectSameAs(postfix("{@x @y :} pattern$1,1 {1 2 :} : list$1,1 {@x @y +} let$2,1"));
    }
    ...
    public void testLetRec() {
        infix("letrec([odd(v)->if(v==0,false,even(v-1)), even(v)->if(v==0,true,odd(v-1))], even(6))")
                .expectResult(TRUE);
        infix("letrec([odd(v)->if(v==0,false,even(v-1)), even(v)->if(v==0,true,odd(v-1))], odd(5))").expectResult(TRUE);
        infix("letrec([odd(v)->if(v==0,false,even(v-1)), even(v)->if(v==0,true,odd(v-1))], odd(4))")
                .expectResult(FALSE);
        infix("letrec([odd(v)->if(v==0,false,even(v-1)), even(v)->if(v==0,true,odd(v-1))], even(3))")
                .expectResult(FALSE);
    ...
    public void testLetRecUnpacking() {
        infix("letrec([x:y = (() -> z() + 'x'):(() -> 'y'), w:z = (()->x() + 'w'):(() -> y() + 'z')], w())")
                .expectResult(s("yzxw"));
    }
    ...
    public void testForcedSymbolGetApply() {
        infix("@if(true, {2+2}, {'else'})").expectSameAs(infix("if(true, 2+2, 'else')"))
                .expectSameAs(prefix("(@if true {(+ 2 2)} {'else'})")).expectSameAs(prefix("(if true (+ 2 2) 'else')"))
                .expectResult(i(4));
    }
    ...
    public void testLambdaCompilation() {
        ...
        infix("(a:b)->a+b").expectSameAs(infix("a:b->a+b"))
                .expectSameAs(postfix("{@a @b :} pattern$1,1 list$1,1 {@a @b +} closure$2,1"));
    }
    ...
    public void testNestedListMatchWithBinding() {
        ...
        infix("match((1:(2:a):b) -> a:b, (_) -> 'fail')(1:(2:3:5):4:6)")
                .expectResult(cons(cons(i(3), i(5)), cons(i(4), i(6))));
    }
    ...
    public void testMatchScope() {
        ...
        infix("let([x: 'pre'], let([b: match((1) -> x, (_) -> false)], let([x: 'post'], b(1))))")
                .expectResult(s("pre"));
    }
    ...
    private class TestDeconstructor implements MetaObject.SlotDecompose {
        ...
        @Override
        public Optional<List<TypedValue>> tryDecompose(TypedValue self, TypedValue input, int variableCount,
                Frame<TypedValue> frame) {
            final List<TypedValue> result = Lists.newArrayList();
            for (int i = 0; i < variableCount; i++) result.add(input);
    ...
    public TypedValue createTestDeconstructor() {
        return domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new TestDeconstructor()).build());
    }
    ...
    public void testDeconstructingMatchWithConsVarBinding() {
        ...
        infix("match((Test(1:a)) -> cons('left', a), (Test(2:a)) -> cons('right', a))(1:5)")
                .expectResult(cons(s("left"), i(5)));
        infix("match((Test(1:a)) -> cons('left', a), (Test(2:a)) -> cons('right', a))(2:7)")
                .expectResult(cons(s("right"), i(7)));
    }
    ...
    public void testMultipleArgMatcherBindingWithGuards() {
        infix("match((1,a) \\ a > 2 -> 'left', (a,b) \\ a < b -> 'right', (_,_) -> 'other')(1,3)")
                .expectResult(s("left"));
        infix("match((1,a) \\ a > 2 -> 'left', (a,b) \\ a < b -> 'right', (_,_) -> 'other')(1,2)")
                .expectResult(s("right"));
        infix("match((1,a) \\ a > 2 -> 'left', (a,b) \\ a < b -> 'right', (_,_) -> 'other')(1,1)")
                .expectResult(s("other"));
    }
    ...
    public void testDeconstructingMatchDifferentConstructors() {
        ...
        infix("match((Test2(a)) -> cons('left', a), (Test3(a)) -> cons('right', a))(2)")
                .expectResult(cons(s("left"), i(2)));
        infix("match((Test2(a)) -> cons('left', a), (Test3(a)) -> cons('right', a))(3)")
                .expectResult(cons(s("right"), i(3)));
    ...
    public void testPrimitiveTypeMatch() {
        infix("match((int(x)) -> 'int':x, (str(x)) -> 'str':x, (bool(x)) -> 'bool':x, (float(x)) -> 'float':x)(5)")
                .expectResult(cons(s("int"), i(5)));
        infix("match((int(x)) -> 'int':x, (str(x)) -> 'str':x, (bool(x)) -> 'bool':x, (float(x)) -> 'float':x)(5.0)")
                .expectResult(cons(s("float"), d(5.0)));
        infix("match((int(x)) -> 'int':x, (str(x)) -> 'str':x, (bool(x)) -> 'bool':x, (float(x)) -> 'float':x)('abc')")
                .expectResult(cons(s("str"), s("abc")));
        infix("match((int(x)) -> 'int':x, (str(x)) -> 'str':x, (bool(x)) -> 'bool':x, (float(x)) -> 'float':x)(true)")
                .expectResult(cons(s("bool"), TRUE));
    }

    @Test
    public void testAltTypes() {
        infix("alt([Maybe=Just(x) \\ Nothing], match((Just(y)) -> y + 1, (Nothing()) -> 'nope')(Just(2)))")
                .expectResult(i(3));
        infix("alt([Maybe=Just(x) \\ Nothing], match((Just(y)) -> y + 1, (Nothing()) -> 'nope')(Nothing()))")
                .expectResult(s("nope"));

        infix(
                "alt([Maybe=Just(x) \\ Nothing], match((Maybe.Just(y)) -> y + 1, (Maybe.Nothing()) -> 'nope')(Maybe.Just(2)))")
                        .expectResult(i(3));
        infix(
                "alt([Maybe=Just(x) \\ Nothing], match((Maybe.Just(y)) -> y + 1, (Maybe.Nothing()) -> 'nope')(Maybe.Nothing()))")
                        .expectResult(s("nope"));

        infix(
                "alt([Tree=Leaf(value)\\Node(left, right)], letrec([f = match((Leaf(v)) -> v, (Node(l,r)) -> f(l) + f(r))], f(Node(Node(Leaf(1), Leaf(4)), Leaf(6)))))")
                        .expectResult(i(11));
        ...
        infix("alt([Tree=Leaf(value)\\Node(left, right)], dir(Tree))")
                .expectResult(list(s("Leaf"), s("Node"), s("name")));
    ...
    public void testAltTypesTyping() {
        ...
        infix("alt([Maybe=Just(x) \\ Nothing], match((Maybe(x)) -> 'maybe', (_) -> 'other')(Just(1)))")
                .expectResult(s("maybe"));
        infix("alt([Maybe=Just(x) \\ Nothing], match((Maybe(x)) -> 'maybe', (_) -> 'other')(Nothing()))")
                .expectResult(s("maybe"));
        infix("alt([Maybe=Just(x) \\ Nothing], match((Maybe(x)) -> 'maybe', (_) -> 'other')(5))")
                .expectResult(s("other"));
    }
    ...
    public void testFormatOperator() {
        ...
        infix("'1 / 2 = %f, 1 / 4 = %f' % [1 / 2, 1 / 4]")
                .expectResult(s(String.format("1 / 2 = %f, 1 / 4 = %f", 0.5, 0.25)));
    }
    ...
    private void assertFirstFewCalledPostfix(String function, TypedValue a, TypedValue b, TypedValue c,
            TypedValue result, int argsCalled) {
        final SymbolStub<TypedValue> stubA = createConstFunction("a", a);
        final SymbolStub<TypedValue> stubB = createConstFunction("b", b);
        final SymbolStub<TypedValue> stubC = createConstFunction("c", c);
    ...
    private void assertFirstFewCalledInfix(String function, TypedValue a, TypedValue b, TypedValue c, TypedValue result,
            int argsCalled) {
        final SymbolStub<TypedValue> stubA = createConstFunction("a", a);
        final SymbolStub<TypedValue> stubB = createConstFunction("b", b);
        final SymbolStub<TypedValue> stubC = createConstFunction("c", c);
    ...
    public void testShortCircuitingLogicOps() {
        ...
        infix("1 && a && 'b' || 2 && c && 'd' || 3 && e && 'f'")
                .expectSameAs(infix("orelse(andthen(1, a, 'b'), andthen(2, c, 'd'), andthen(3, e, 'f'))"));
    }
    ...
    public void testNullAwareDefaultOpChaining() {
        ...
        class TestSlotSlice implements MetaObject.SlotSlice {
            ...
            public TypedValue slice(TypedValue self, TypedValue range, Frame<TypedValue> frame) {
                ...
                return domain.create(
                        DummyObject.class,
                        DUMMY,
                        MetaObject.builder().set(new TestSlotSlice(newPath)).set(new TestSlotCall(newPath)).build());
            }
        }
        ...
        sut.environment.setGlobalSymbol(
                ...
                domain.create(
                        DummyObject.class,
                        DUMMY,
                        MetaObject.builder().set(new TestSlotSlice(NULL)).set(new TestSlotCall(NULL)).build()));
    ...
    public void testNullAwareAccessOperator() {
        ...
        sut.environment.setGlobalSymbol(
                "a",
                domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new TestStructured()).build()));
    ...
    public void testNullAwareWithOperator() {
        ...
        infix("let([t=a], t?.{ cons(m_test1, m_test2) })")
                .expectResult(cons(cons(s("get"), s("m_test1")), cons(s("get"), s("m_test2"))));
    ...
    public void testStructSymbol() {
        ...
        infix("let([Point=struct(#x,#y)], match((Point(x)) -> 'point', (_) -> 'other')(Point()))")
                .expectResult(s("point"));
        ...
        infix(
                "letseq([Point=struct(#x,#y), p1 = Point(#y:3), p2 = p1(#x:2), p3 = p1(#y:8)], list(p1.x:p1.y, p2.x:p2.y, p3.x:p3.y))")
                        .expectResult(list(cons(nil(), i(3)), cons(i(2), i(3)), cons(nil(), i(8))));
        ...
        infix("let([Point1=struct(#x,#y), Point2=struct(#x,#y)], Point1(#x:5,#y:6) ==  Point2(#x:5,#y:6))")
                .expectResult(FALSE);
    }
    ...
    public void testDict() {
        ...
        assertSameListContents(
                Sets.newHashSet(i(1), s("a"), complex(0, 2)),
                infix("dict(1:'a','a':#b,2I:5).keys").executeAndPop());
        assertSameListContents(
                Sets.newHashSet(s("a"), sym("b"), i(5)),
                infix("dict(1:'a','a':#b,2I:5).values").executeAndPop());
        assertSameListContents(
                Sets.newHashSet(cons(i(1), s("a")), cons(s("a"), sym("b")), cons(complex(0, 2), i(5))),
                infix("dict(1:'a','a':#b,2I:5).items").executeAndPop());

        infix(
                "let([d = dict(1:'a','a':#b)], (d.update(#b:4,3:'4') == dict(1:'a','a':#b, #b:4, 3:'4')) && (d == dict(1:'a','a':#b)))")
                        .expectResult(TRUE);
        assertSameListContents(
                Sets.newHashSet(cons(i(1), s("a")), cons(s("a"), sym("b")), cons(sym("b"), i(4)), cons(i(3), s("4"))),
                infix("dict(1:'a','a':#b).update(#b:4,3:'4').items").executeAndPop());
        assertSameListContents(
                Sets.newHashSet(cons(i(1), s("a")), cons(s("a"), sym("b")), cons(sym("b"), i(4)), cons(i(3), s("4"))),
                infix("dict(1:'a','a':#b)(#b:4,3:'4').items").executeAndPop());

        infix("let([d = dict(1:'a','a':#b)], (d.remove(1,#what) == dict('a':#b)) && (d == dict(1:'a','a':#b)))")
                .expectResult(TRUE);
        assertSameListContents(
                Sets.newHashSet(cons(s("a"), sym("b"))),
                infix("dict(1:'a','a':#b).remove(1,#what).items").executeAndPop());
    ...
    public void testOptional() {
        ...
        infix("match((optional.present(v)) -> 'present':v, (optional.absent()) -> 'absent')(optional.from(5))")
                .expectResult(cons(s("present"), i(5)));
        infix("match((optional.present(v)) -> 'present':v, (optional.absent()) -> 'absent')(optional.from(null))")
                .expectResult(s("absent"));
    ...
    public void testSlotPredicates() {
        sut.environment.setGlobalSymbol(
                "test",
                domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new MetaObject.SlotBool() {
    ...
    public void testCustomMetaCreationAndSetting() {
        ...
        infix(
                "let([callableInt=setmetaobject(13, metaobject(slots.call = (self, other) -> self + other))], callableInt(21))")
                        .expectResult(i(34));
    }
    ...
    public void testCustomMetaObjectWithNativeSlots() {
        infix(
                "letseq([originalMetaobject = getmetaobject(3), callableInt=setmetaobject(13, metaobject(slots.call = (self) -> self + 1, slots.str=originalMetaobject.str))], str(callableInt) + ' ' + str(callableInt()))")
                        .expectResult(s("13 14"));
    }

    @Test
    public void testCustomMetaObjectUpdateFromNative() {
        infix(
                "letseq([originalMetaobject = getmetaobject('s'), callableStr=setmetaobject('hello', originalMetaobject(slots.call = (self) -> 'world'))], callableStr + ' ' + callableStr())")
    ...
    public void testCustomMetaObjectAttrSlot() {
        infix(
                "letseq([mo = metaobject(slots.attr = (self, key) -> optional.present('m_' + self + '_' + key)), o1=setmetaobject('a', mo), o2=setmetaobject('b', mo)], (o1.x:o1.y):(o2.x:o2.y))")
                        .expectResult(cons(cons(s("m_a_x"), s("m_a_y")), cons(s("m_b_x"), s("m_b_y"))));
    ...
    public void testCustomMetaObjectBoolSlot() {
        infix(
                "letseq([mo = metaobject(slots.bool = (self) -> self == 'yup'), o_true=setmetaobject('yup', mo), o_false=setmetaobject('nope', mo)], bool(o_true):bool(o_false))")
                        .expectResult(cons(TRUE, FALSE));
    ...
    public void testCustomMetaObjectCallSlot() {
        infix(
                "letseq([mo = metaobject(slots.call = (self, a, b) -> if(self == 'left', a, b)), left=setmetaobject('left', mo), right=setmetaobject('right', mo)], left(1,2):right(1,2))")
                        .expectResult(cons(i(1), i(2)));
    ...
    public void testCustomMetaObjectEqualsSlot() {
        infix(
                "letseq([s='abcd', l=len(s), mo = metaobject(slots.equals = (self, other) -> l == len(other)), o=setmetaobject('abcd', mo)], (o == 'defg'):(o == 'abc'))")
                        .expectResult(cons(TRUE, FALSE));
    ...
    public void testCustomMetaObjectLengthSlot() {
        infix("letseq([mo = metaobject(slots.length = (self) -> int(self) + 7), o=setmetaobject(5, mo)], len(o))")
                .expectResult(i(12));
    ...
    public void testCustomMetaObjectReprSlot() {
        infix("letseq([mo = metaobject(slots.repr = (self) -> $'<{self}>'), o=setmetaobject('test', mo)], repr(o))")
                .expectResult(s("<test>"));
    ...
    public void testCustomMetaObjectStrSlot() {
        infix("letseq([mo = metaobject(slots.str = (self) -> 'hello'), o=setmetaobject('123', mo)], str(o))")
                .expectResult(s("hello"));
        infix("str.metaobject.str('abc')").expectResult(s("abc"));
    }

    @Test
    public void testCustomMetaObjectSliceSlot() {
        infix("letseq([mo = metaobject(slots.slice = (self, index) -> self + index), o=setmetaobject(15, mo)], o[20])")
                .expectResult(i(35));
    ...
    public void testCustomMetaObjectTypeSlot() {
        infix("letseq([mo = metaobject(slots.type = (self) -> 'what?'), o=setmetaobject(15, mo)], type(o))")
                .expectResult(s("what?"));
    ...
    public void testCustomMetaObjectDecomposeSlot() {
        infix(
                "letseq([mo = metaobject(slots.decompose = (self, value, count) -> if(value == 'go', optional.present((self + 1):(self + 3)), optional.absent())), O=setmetaobject(15, mo)], match((O(a, b)) -> a:b, (_) -> 'other')('go'))")
                        .expectResult(cons(i(16), i(18)));
        infix(
                "letseq([mo = metaobject(slots.decompose = (self, value, count) -> if(value == 'go', optional.present((self + 1):(self + 3)), optional.absent())), O=setmetaobject(15, mo)], match((O(a, b)) -> a:b, (_) -> 'other')('no go'))")
                        .expectResult(s("other"));
    ...
    public void testCustomMetaObjectDirSlot() {
        infix("letseq([mo = metaobject(slots.dir = (self) -> ['a','b','c']), o=setmetaobject(15, mo)], dir(o))")
                .expectResult(list(s("a"), s("b"), s("c")));

        sut.environment.setGlobalSymbol(
                "test",
                domain.create(DummyObject.class, DUMMY, MetaObject.builder().set(new MetaObject.SlotDir() {
    ...
    public void testEnumerateFunction() {
        ...
        infix("enumerate(['a','b','c'])")
                .expectResult(list(cons(i(0), s("a")), cons(i(1), s("b")), cons(i(2), s("c"))));
    }
    ...
    public void testZipFunction() {
        ...
        infix("map((a:b:c)->b*c+a, zip(['o','m','g'], zip(['a','b','c'],[1,2,3])))")
                .expectResult(list(s("ao"), s("bbm"), s("cccg")));
    }
    ...
    public void testSortFunction() {
        ...
        infix("sort([10.1,20,'30.1','30.0'], #key=(x)->float(x), #cmp=(a,b)->int(b-a))")
                .expectResult(list(s("30.1"), s("30.0"), i(20), d(10.1)));
    }
    ...
    public void testVarargLambdaInLet() {
        ...
        infix("let([f(a, *arg) -> a:'var':arg], f('b', 1, 2, 3))")
                .expectResult(list(s("b"), s("var"), i(1), i(2), i(3)));
    }
    ...
    public void testArgUnpackCompilationAndRuntime() {
        sut.environment.setGlobalSymbol("test", new CallableLogger());
        infix("test(*[])").expectSameAs(postfix("@test list$0,1 applyvar$2,1")).expectResult(s("()"));

        infix("test('a',*[])").expectSameAs(postfix("@test 'a' list$0,1 applyvar$3,1")).expectResult(s("(a)"));

        infix("test(*['1'])").expectSameAs(postfix("@test '1' list$1,1 applyvar$2,1")).expectResult(s("(1)"));

        infix("test(*['1','2'])").expectSameAs(postfix("@test '1' '2' list$2,1 applyvar$2,1")).expectResult(s("(1,2)"));

        infix("test('a',*['1','2'])").expectSameAs(postfix("@test 'a' '1' '2' list$2,1 applyvar$3,1"))
                .expectResult(s("(a,1,2)"));

        infix("test(*['1'], 'a')").expectSameAs(postfix("@test '1' list$1,1 'a' list$1,1 flatten$2,1 applyvar$2,1"))
                .expectResult(s("(1,a)"));
        ...
        infix("test('a', *['1'], 'b', 'c', *['2','3'])")
                .expectSameAs(
                        postfix("@test 'a' '1' list$1,1 'b' 'c' list$2,1 '2' '3' list$2,1 flatten$3,1 applyvar$3,1"))
    ...
    public void testArgUnpackOnLocalVars() {
        ...
        infix("let([v=['1','2']], test(*v))").expectResult(s("(1,2)"));

        infix("let([a1='a', a2='b', v=['1','2']], test(a1, *v, a2))").expectResult(s("(a,1,2,b)"));
    }
    ...
    public void testRandom() {
        {
            ...
            infix("let([r=random(3071)], r.nextInt():r.nextInt())")
                    .expectResult(cons(i(testRandom.nextInt()), i(testRandom.nextInt())));
        }

        {
            final Random testRandom = new Random(1103);
            infix("let([r=random(1103)], r.nextInt(6):r.nextInt(6))")
                    .expectResult(cons(i(testRandom.nextInt(6)), i(testRandom.nextInt(6))));
        }

        {
            final Random testRandom = new Random(1677);
            infix("let([r=random(1677)], r.nextBoolean():r.nextBoolean())")
                    .expectResult(cons(b(testRandom.nextBoolean()), b(testRandom.nextBoolean())));
        }
    }
