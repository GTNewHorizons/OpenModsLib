...
public class TypedUnaryOperatorTest {
    ...
    private static void assertValueEquals(TypedValue value, TypeDomain expectedDomain, Class<?> expectedType,
    ...
    public void testTypedOperation() {
        ...
        final TypedUnaryOperator op = new TypedUnaryOperator.Builder("*").registerOperation(new IOperation<Integer>() {
    ...
    public void testDefaultOperation() {
        ...
        final TypedUnaryOperator op = new TypedUnaryOperator.Builder("*").setDefaultOperation(new IDefaultOperation() {
