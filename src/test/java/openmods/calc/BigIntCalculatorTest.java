...
public class BigIntCalculatorTest {
    ...
    public void testConstantEvaluatingBrackets() {
        final SymbolStub<BigInteger> stub = new SymbolStub<BigInteger>().allowCalls().expectArgs(v(1), v(2))
                .verifyArgCount().setReturns(v(5), v(6), v(7)).verifyReturnCount();
    ...
    public void testNestedConstantEvaluatingBrackets() {
        final SymbolStub<BigInteger> stub = new SymbolStub<BigInteger>().allowGets().setGetValue(v(5));
        sut.environment.setGlobalSymbol("dummy", stub);
    ...
    public void testConstantEvaluatingSymbol() {
        final SymbolStub<BigInteger> stub = new SymbolStub<BigInteger>().allowCalls().expectArgs(v(1), v(2))
                .verifyArgCount().setReturns(v(5)).verifyReturnCount();
        sut.environment.setGlobalSymbol("dummy", stub);
