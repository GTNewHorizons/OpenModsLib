...
public class DataStoreBuilder<K, V> {
    ...
    DataStoreBuilder(DataStoreManager owner, DataStoreKey<K, V> key, Class<? extends K> keyClass,
    ...
    public DataStoreKey<K, V> register() {
        ...
        final DataStoreWrapper<K, V> wrapper = new DataStoreWrapper<K, V>(
                values,
                keyWriter,
                valueWriter,
                keyReader,
        ...
        for (IDataVisitor<K, V> visitor : visitors) wrapper.addVisitor(visitor);
    ...
    public void addEntry(K key, V value) {
        ...
        Preconditions.checkState(
                prev == null,
                "Replacing value for key %s: %s -> %s, id: %s",
                key,
                prev,
                value,
                this.key.id);
