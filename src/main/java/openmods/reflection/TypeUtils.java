...
public class TypeUtils {
    ...
    public static final BiMap<Class<?>, Class<?>> PRIMITIVE_TYPES_MAP = ImmutableBiMap.<Class<?>, Class<?>>builder()
            ...
            .put(short.class, Short.class).put(int.class, Integer.class).put(long.class, Long.class)
            .put(float.class, Float.class).put(double.class, Double.class).put(void.class, Void.class).build();
    ...
    public static TypeToken<?> getTypeParameter(Class<?> intfClass, Class<?> instanceClass, int index) {
        ...
        Preconditions
                .checkArgument(type.getRawType() != Object.class, "Type %s is no fully parametrized", instanceClass);
