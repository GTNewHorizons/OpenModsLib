...
public class ModStartupHelper {
    ...
    public void preInit(Configuration config) {
        ...
        for (Class<? extends BlockInstances> blockHolder : blockHolders) features.collectFromBlocks(blockHolder);

        for (Class<? extends ItemInstances> itemHolder : itemHolders) features.collectFromItems(itemHolder);
        ...
        for (Class<? extends BlockInstances> blockHolder : blockHolders) gameConfig.registerBlocks(blockHolder);

        for (Class<? extends ItemInstances> itemHolder : itemHolders) gameConfig.registerItems(itemHolder);
