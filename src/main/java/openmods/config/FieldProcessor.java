...
public class FieldProcessor {
    ...
    private static <A extends Annotation, T> void processEntries(Class<? extends InstanceContainer<T>> container,
            Class<? extends A> annotationCls, Class<T> fieldCls, FieldValueVisitor<T> visitor) {
