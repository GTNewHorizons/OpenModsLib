...
public class ShaderHelper {
    ...
    /**
     * Class for shader functions, calling ARB methods if GL20 is not supported A lot of this is already implemented in
     * OpenGlHelper, but it misses some methods and is confusing in general.
     */
