...
public final class OpenClientProxy implements IOpenModsProxy {
    ...
    public void preInit() {
        ...
        ClientCommandHandler.instance
                .registerCommand(new CommandSource("om_source_c", false, OpenMods.instance.getCollector()));

        if (LibConfig.enableCalculatorCommands) {
            final ICommandComponent commandRoot = new CommandCalcFactory(new File(getMinecraftDir(), "scripts"))
                    .getRoot();
        ...
        FMLCommonHandler.instance().registerCrashCallable(new ICrashCallable() {
            ...
            public String call() throws Exception {
                ...
                return String.format(
                        "Function set: %s, pool: %s, bits: %s",
                        FramebufferConstants.getMethodSet(),
                        pool.getType(),
                        pool.getSize());
            }
