...
public enum BlockRotationMode {
    ...
    /**
     * Two orientations - either N-S or W-E. Top side remains unchanged. Placement side will become local north or
     * south. Tool rotation will either rotate around Y (if clicked T or B) or set to clicked side (otherwise).
     */
    ...
    /**
     * Three orientations: N-S, W-E, T-B. Placement side will become local top or bottom. Tool rotation will set top
     * direction to clicked side.
     */
    ...
    /**
     * Rotate around Y in for directions: N,S,W,E. Placement side will become local north. Tool rotation will either
     * rotate around Y (if clicked T or B) or set to clicked side (otherwise).
     */
    FOUR_DIRECTIONS(RotationAxis.THREE_AXIS, Orientation.XP_YP, Orientation.ZN_YP, Orientation.XN_YP,
            Orientation.ZP_YP) {
    ...
    /**
     * Rotations in every direction. Placement side will become local top. Tool rotation will set top to clicked side.
     */
    SIX_DIRECTIONS(RotationAxis.THREE_AXIS, Orientation.XN_YN, Orientation.XP_YP, Orientation.XP_ZN, Orientation.XP_ZP,
            Orientation.YP_XN, Orientation.YN_XP) {
    ...
    /**
     * And now it's time for weird ones... Three orientations: N-S, W-E, T-B. Placement side will become local top or
     * bottom. Side can be rotated in four directions
     */
    THREE_FOUR_DIRECTIONS(RotationAxis.THREE_AXIS, Orientation.XP_YP, Orientation.XN_YP, Orientation.ZP_YP,
            Orientation.ZN_YP, Orientation.YP_XN, Orientation.YN_XN, Orientation.ZP_XN, Orientation.ZN_XN,
    ...
    /**
     * Yet another weird one. Top side can rotate when oriented up or down. When top points to cardinal direction,
     * texture top should always align with horizon
     */
    TWELVE_DIRECTIONS(RotationAxis.THREE_AXIS, Orientation.lookupYZ(HalfAxis.NEG_Y, HalfAxis.NEG_Z), // first two
                                                                                                     // TOP/BOTTOM
                                                                                                     // orientation are
                                                                                                     // here for easy
                                                                                                     // migration from
            ...
            Orientation.lookupYZ(HalfAxis.NEG_Z, HalfAxis.NEG_Y), Orientation.lookupYZ(HalfAxis.POS_Z, HalfAxis.NEG_Y),
            Orientation.lookupYZ(HalfAxis.NEG_X, HalfAxis.NEG_Y), Orientation.lookupYZ(HalfAxis.POS_X, HalfAxis.NEG_Y),

            Orientation.lookupYZ(HalfAxis.NEG_Y, HalfAxis.POS_Z), Orientation.lookupYZ(HalfAxis.NEG_Y, HalfAxis.NEG_X),
            Orientation.lookupYZ(HalfAxis.NEG_Y, HalfAxis.POS_X),

            Orientation.lookupYZ(HalfAxis.POS_Y, HalfAxis.NEG_Z), Orientation.lookupYZ(HalfAxis.POS_Y, HalfAxis.POS_X),
    ...
    private BlockRotationMode(ForgeDirection[] rotations, Orientation... validOrientations) {
        ...
        if (count == 0) {
            ...
            for (int i = count; i < idToOrientation.length; i++) idToOrientation[i] = idToOrientation[0];
        }
