...
public class BlockTextureTransform {
    ...
    public static class Builder {
        ...
        private Builder() {
            for (ForgeDirection dir : ForgeDirection.VALID_DIRECTIONS) transforms.put(dir, Matrix2d.createIdentity());
        }
    ...
    private BlockTextureTransform(Map<ForgeDirection, Matrix2d> transforms,
            Map<ForgeDirection, Matrix2d> inverseTransforms) {
