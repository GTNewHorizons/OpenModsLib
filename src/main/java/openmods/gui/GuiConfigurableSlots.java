...
public abstract class GuiConfigurableSlots<T extends TileEntity & ISyncMapProvider & IConfigurableGuiSlots<E>, C extends ContainerBase<T>, E extends Enum<E>>
    ...
    protected final BaseComposite createRoot() {
        ...
        for (E slot : getSlots()) {
            ...
            setupSelector(
                    sideSelector,
                    te.createAllowedDirectionsProvider(slot),
                    te.createAllowedDirectionsReceiver(slot));
    ...
    private void setupSelector(GuiComponentSideSelector selector, IValueProvider<Set<ForgeDirection>> source,
            final IWriteableBitMap<ForgeDirection> updater) {
    ...
    private void setupCheckBox(final GuiComponentCheckbox checkbox, IValueProvider<Boolean> source,
            final IValueReceiver<Boolean> updater) {
