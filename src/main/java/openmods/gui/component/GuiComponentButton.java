...
public abstract class GuiComponentButton extends GuiComponentResizable {
    ...
    public void render(Minecraft minecraft, int offsetX, int offsetY, int mouseX, int mouseY) {
        ...
        BoxRenderer box = buttonEnabled ? (pressed ? BOX_RENDERER_PRESSED : BOX_RENDERER_NORMAL)
                : BOX_RENDERER_DISABLED;
        bindComponentsSheet();
    ...
    protected abstract void renderContents(Minecraft minecraft, int offsetX, int offsetY, int mouseX, int mouseY,
            boolean pressed);
