...
public class MappedExprNodeFactory<E> extends DefaultExprNodeFactory<E> {
    ...
    public IExprNode<E> createBracketNode(String openingBracket, String closingBracket, List<IExprNode<E>> children) {
        ...
        return nodeFactory != null ? nodeFactory.create(children)
                : createDefaultBracketNode(openingBracket, closingBracket, children);
    }

    protected IExprNode<E> createDefaultBracketNode(String openingBracket, String closingBracket,
            List<IExprNode<E>> children) {
    ...
    public IExprNode<E> createBinaryOpNode(BinaryOperator<E> op, IExprNode<E> leftChild, IExprNode<E> rightChild) {
        ...
        return nodeFactory != null ? nodeFactory.create(leftChild, rightChild)
                : createDefaultBinaryOpNode(op, leftChild, rightChild);
    }

    protected IExprNode<E> createDefaultBinaryOpNode(BinaryOperator<E> op, IExprNode<E> leftChild,
            IExprNode<E> rightChild) {
