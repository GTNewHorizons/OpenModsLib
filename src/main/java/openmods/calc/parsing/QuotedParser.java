...
public class QuotedParser<E> implements IAstParser<E> {
    ...
    public interface IQuotedExprNodeFactory<E> {
        ...
        public IExprNode<E> createBracketNode(String openingBracket, String closingBracket,
    ...
    private IExprNode<E> parseNestedQuotedNode(String openingBracket, PeekingIterator<Token> input,
            IQuotedExprNodeFactory<E> exprNodeFactory) {
