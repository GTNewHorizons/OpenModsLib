...
public abstract class SingleStateTransition<E> {
    ...
    public static abstract class ForModifier<E> extends SingleStateTransition<E>
            implements IModifierStateTransition<E> {
    ...
    public static abstract class ForSymbol<E> extends SingleStateTransition<E>
