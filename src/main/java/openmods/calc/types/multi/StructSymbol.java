...
public class StructSymbol extends SingleReturnCallable<TypedValue> {
    ...
    private class StructValue {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof StructValue) {
                ...
                return (this.type == other.type) && (values.equals(other.values));
            }
            return false;
        }
    ...
    private class StructType extends TypeUserdata {
        ...
        public StructType(List<String> fields) {
            ...
            final List<TypedValue> wrappedFieldNames = Lists
                    .newArrayList(Iterables.transform(fieldNames, domain.createWrappingTransformer(String.class)));
    ...
    private MetaObject createStructTypeMetaObject() {
        return MetaObject.builder().set(TypeUserdata.defaultAttrSlot(domain)).set(TypeUserdata.defaultDirSlot())
                .set(MetaObjectUtils.DECOMPOSE_ON_TYPE).set(new MetaObject.SlotCall() {
                    ...
                    public void call(TypedValue self, OptionalInt argumentsCount, OptionalInt returnsCount,
                        ...
                        for (String field : type.fieldNames) values.put(field, nullValue);
