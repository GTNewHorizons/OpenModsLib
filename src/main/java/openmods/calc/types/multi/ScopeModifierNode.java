...
public abstract class ScopeModifierNode extends SymbolCallNode<TypedValue> {
    ...
    public ScopeModifierNode(TypeDomain domain, String symbol, BinaryOperator<TypedValue> colonOperator,
            BinaryOperator<TypedValue> assignOperator, List<IExprNode<TypedValue>> args) {
        super(symbol, args);
        this.domain = domain;
        this.symbol = symbol;
    ...
    public void flatten(List<IExecutable<TypedValue>> output) {
        ...
        Preconditions.checkState(
                ...
                "Expected square brackets, got %s",
                argsNode);
    ...
    protected abstract void flattenNameAndValue(List<IExecutable<TypedValue>> output, IExprNode<TypedValue> name,
