...
public class TypedValueCalculatorFactory {
        ...
        public IExprNode<TypedValue> create(IExprNode<TypedValue> arg) {
            return new UnaryOpNode<TypedValue>(op, arg) {
                ...
                public void flatten(List<IExecutable<TypedValue>> output) {
                    throw new UnsupportedOperationException("Operator " + op + " cannot be used in this context"); // should
                                                                                                                   // be
                                                                                                                   // captured
                                                                                                                   // before
                                                                                                                   // serialization;
    ...
    private static final Set<Class<?>> NUMBER_TYPES = ImmutableSet
            .<Class<?>>of(Double.class, Boolean.class, BigInteger.class, Complex.class);
    ...
    public static Calculator<TypedValue, ExprType> create() {
...

        {
            ...
            domain.registerType(
                    UnitType.class,
                    "<null>",
                    MetaObject.builder().set(MetaObjectUtils.BOOL_ALWAYS_FALSE).set(new MetaObject.SlotLength() {

                        @Override
                        public int length(TypedValue self, Frame<TypedValue> frame) {
                            return 0;
                        }
                    }).set(MetaObjectUtils.strConst("null")).set(MetaObjectUtils.reprConst("null"))
                            .set(MetaObjectUtils.typeConst(nullType)).build(),
                    UnitType.INSTANCE);
        }
        ...
        {
            final TypedValue intType = domain.create(
                    TypeUserdata.class,
                    new TypeUserdata("int", BigInteger.class),
                    TypeUserdata.defaultMetaObject(domain)
                            .set(MetaObjectUtils.callableAdapter(new SimpleTypedFunction(domain) {
                                ...
                                @Variant
                                public BigInteger convert(@DispatchArg String value,
                                        @OptionalArgs Optional<BigInteger> radix) {
                                    final int usedRadix = radix.transform(INT_UNWRAP).or(valuePrinter.base);
                                    final Pair<BigInteger, Double> result = TypedValueParser.NUMBER_PARSER
                                            .parseString(value, usedRadix);
                                    Preconditions.checkArgument(
                                            result.getRight() == null,
                                            "Fractional part in argument to 'int': %s",
                                            value);
            ...
            }).set(integerAttrs.createAttrSlot()).set(integerAttrs.createDirSlot())
                    .set(MetaObjectUtils.typeConst(intType)).set(new MetaObject.SlotStr() {
        ...
        {
            final TypedValue floatType = domain.create(
                    TypeUserdata.class,
                    new TypeUserdata("float", Double.class),
                    TypeUserdata.defaultMetaObject(domain)
                            .set(MetaObjectUtils.callableAdapter(new SimpleTypedFunction(domain) {

                                @Variant
                                public Double convert(
                                        @DispatchArg(extra = { BigInteger.class, Boolean.class }) Double value) {
                                    return value;
                                }

                                @Variant
                                public Double convert(@DispatchArg String value,
                                        @OptionalArgs Optional<BigInteger> radix) {
                                    final int usedRadix = radix.transform(INT_UNWRAP).or(valuePrinter.base);
                                    final Pair<BigInteger, Double> result = TypedValueParser.NUMBER_PARSER
                                            .parseString(value, usedRadix);
        ...
        {
            final TypedValue boolType = domain.create(
                    TypeUserdata.class,
                    new TypeUserdata("bool", Boolean.class),
                    TypeUserdata.defaultMetaObject(domain).set(MetaObjectUtils.callableAdapter(new SlotCaller() {

                        @Override
                        protected TypedValue callSlot(Frame<TypedValue> frame, TypedValue value,
        ...
        {
            final TypedValue strType = domain.create(
                    TypeUserdata.class,
                    new TypeUserdata("str", String.class),
                    TypeUserdata.defaultMetaObject(domain)
            ...
            }).set(stringAttrs.createAttrSlot()).set(stringAttrs.createDirSlot())
                    .set(MetaObjectUtils.typeConst(strType)).set(new MetaObject.SlotStr() {
        ...
        {
            final TypedValue complexType = domain.create(
                    TypeUserdata.class,
                    new TypeUserdata("complex", Complex.class),
                    TypeUserdata.defaultMetaObject(domain)
                            .set(MetaObjectUtils.callableAdapter(new SimpleTypedFunction(domain) {
        ...
        {
            final TypedValue consType = domain.create(
                    TypeUserdata.class,
                    new TypeUserdata("cons", Cons.class),
                    TypeUserdata.defaultMetaObject(domain)
            ...
            }).set(MetaObjectUtils.BOOL_ALWAYS_TRUE).set(MetaObjectUtils.typeConst(consType))
        ...
        {
            final TypedValue symbolType = domain.create(
                    TypeUserdata.class,
                    new TypeUserdata("symbol", Symbol.class),
                    TypeUserdata.defaultMetaObject(domain)
                            .set(MetaObjectUtils.callableAdapter(new SimpleTypedFunction(domain) {
            ...
            domain.registerType(
                    Symbol.class,
                    "symbol",
                    MetaObject.builder().set(MetaObjectUtils.BOOL_ALWAYS_TRUE)
                            .set(MetaObjectUtils.typeConst(symbolType)).set(new MetaObject.SlotStr() {
...

        {
            ...
            final TypedValue functionType = domain
                    .create(TypeUserdata.class, new TypeUserdata("function", CallableValue.class));
            ...
            domain.registerType(CallableValue.class, "function", MetaObject.builder().set(new MetaObject.SlotCall() {
                ...
                @Override
                public void call(TypedValue self, OptionalInt argCount, OptionalInt returnsCount,
...

        {
            ...
            domain.registerType(
                    Code.class,
                    "code",
                    MetaObject.builder().set(MetaObjectUtils.BOOL_ALWAYS_TRUE).set(MetaObjectUtils.typeConst(codeType))
                            .build());
        }
        ...
        // arithmetic
        final BinaryOperator.Direct<TypedValue> addOperator = operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("+", PRIORITY_ADD)
        ...
        operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("-", PRIORITY_ADD)
                        .registerOperation(new TypedBinaryOperator.ISimpleCoercedOperation<BigInteger, BigInteger>() {
        ...
        final BinaryOperator<TypedValue> multiplyOperator = operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("*", PRIORITY_MULTIPLY)
                        .registerOperation(new TypedBinaryOperator.ISimpleCoercedOperation<BigInteger, BigInteger>() {
                            ...
                            public BigInteger apply(Boolean left, Boolean right) {
                                ...
                                new TypedBinaryOperator.ISimpleVariantOperation<String, BigInteger, String>() {
        ...
        final BinaryOperator.Direct<TypedValue> divideOperator = operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("/", PRIORITY_MULTIPLY)
                        .registerOperation(new TypedBinaryOperator.ISimpleCoercedOperation<Double, Double>() {
        ...
        operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("**", PRIORITY_EXP)
                        .registerOperation(new TypedBinaryOperator.ISimpleCoercedOperation<Boolean, BigInteger>() {
                            ...
                            public TypedValue apply(TypeDomain domain, BigInteger left, BigInteger right) {
                                ...
                                return exp >= 0 ? domain.create(BigInteger.class, left.pow(exp))
                                        : domain.create(Double.class, Math.pow(left.doubleValue(), exp));
                            }
                        }).registerOperation(new TypedBinaryOperator.ISimpleCoercedOperation<Double, Double>() {
        ...
        final BinaryOperator<TypedValue> andOperator = operators
                .registerBinaryOperator(new BinaryLogicOperator("&&", PRIORITY_LOGIC_AND) {

                    @Override
                    public TypedValue select(boolean firstBool, TypedValue left, TypedValue right) {
                        Preconditions.checkArgument(
                                left.domain == right.domain,
                                "Values from different domains: %s, %s",
                                left,
                                right);
        ...
        final BinaryOperator<TypedValue> orOperator = operators
                .registerBinaryOperator(new BinaryLogicOperator("||", PRIORITY_LOGIC_OR) {
        ...
        final BinaryOperator<TypedValue> nonNullOperator = operators
                .registerBinaryOperator(new BinaryOperator.Direct<TypedValue>("??", PRIORITY_NULL_AWARE) {
        ...
        operators.registerUnaryOperator(
                new TypedUnaryOperator.Builder("~")
                        .registerOperation(new TypedUnaryOperator.ISimpleOperation<Boolean, BigInteger>() {
        ...
        operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("&", PRIORITY_BITWISE_AND)
        ...
        operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("|", PRIORITY_BITWISE_OR)
                        .registerOperation(new TypedBinaryOperator.ISimpleCoercedOperation<Boolean, Boolean>() {
        ...
        operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("^", PRIORITY_BITWISE_XOR)
                        .registerOperation(new TypedBinaryOperator.ISimpleCoercedOperation<Boolean, Boolean>() {
        ...
        operators.registerBinaryOperator(
                new TypedBinaryOperator.Builder("<<", PRIORITY_BITSHIFT)
                        .registerOperation(new TypedBinaryOperator.ISimpleCoercedOperation<Boolean, BigInteger>() {
        ...
        final BinaryOperator.Direct<TypedValue> ltOperator = operators
                .registerBinaryOperator(new BooleanComparatorOperator("<", PRIORITY_COMPARE) {
        ...
        final BinaryOperator.Direct<TypedValue> gtOperator = operators
                .registerBinaryOperator(new BooleanComparatorOperator(">", PRIORITY_COMPARE) {
        ...
        final BinaryOperator<TypedValue> dotOperator = operators
                .registerBinaryOperator(new DotOperator(".", PRIORITY_MAX)).unwrap();

        final BinaryOperator<TypedValue> nullAwareDotOperator = operators
                .registerBinaryOperator(new DotOperator("?.", PRIORITY_MAX)).unwrap();
        ...
        final BinaryOperator<TypedValue> lambdaOperator = operators
                .registerBinaryOperator(new MarkerBinaryOperator("->", PRIORITY_LAMBDA, Associativity.RIGHT)).unwrap();

        final BinaryOperator<TypedValue> splitOperator = operators
                .registerBinaryOperator(new MarkerBinaryOperator("\\", PRIORITY_SPLIT, Associativity.RIGHT)).unwrap();

        final BinaryOperator<TypedValue> colonOperator = operators
                .registerBinaryOperator(new BinaryOperator.Direct<TypedValue>(":", PRIORITY_CONS, Associativity.RIGHT) {
        ...
        final BinaryOperator<TypedValue> assignOperator = operators
                .registerBinaryOperator(new BinaryOperator.Direct<TypedValue>("=", PRIORITY_ASSIGN) {
        ...
        final BinaryOperator<TypedValue> defaultOperator = operators
                .registerDefaultOperator(new MarkerBinaryOperator("<?>", PRIORITY_MAX));

        final BinaryOperator<TypedValue> nullAwareOperator = operators
                .registerBinaryOperator(new MarkerBinaryOperator("?", PRIORITY_MAX)).unwrap();
        ...
        class TypedValueSymbolMap extends TopSymbolMap<TypedValue> {
            ...
            protected ISymbol<TypedValue> createSymbol(TypedValue value) {
                if (value.is(CallableValue.class)) return value.as(CallableValue.class).toSymbol(value);
        ...
        for (Map.Entry<String, TypedValue> e : basicTypes.entrySet()) envMap.put(e.getKey(), e.getValue());
        ...
        {
            final TypedValue polar = domain
                    .create(CallableValue.class, CallableValue.from(new SimpleTypedFunction(domain) {
                        ...
                        @Override
                        public Optional<List<TypedValue>> tryDecompose(TypedValue self, TypedValue input,
                                int variableCount, Frame<TypedValue> frame) {
                            Preconditions.checkState(
                                    variableCount == 2,
                                    "'polar' can provide 2 values, but code expects %s",
                                    variableCount);
        ...
        {
            final TypedValue cartesian = domain
                    .create(CallableValue.class, CallableValue.from(new SimpleTypedFunction(domain) {
                        ...
                        public Optional<List<TypedValue>> tryDecompose(TypedValue self, TypedValue input,
                            ...
                            Preconditions.checkState(
                                    variableCount == 2,
                                    "'cartesian' can provide 2 values, but code expects %s",
                                    variableCount);
                            if (input.is(Complex.class)) {
                                final Complex value = input.as(Complex.class);
        ...
        env.setGlobalSymbol("number", new SimpleTypedFunction(domain) {
            ...
            @Variant
            @RawReturn
            public TypedValue convert(@RawDispatchArg({ Boolean.class, BigInteger.class, Double.class,
                    Complex.class }) TypedValue value) {
                return value;
            }
        ...
        env.setGlobalSymbol("parse", new SimpleTypedFunction(domain) {
            ...
            public TypedValue parse(String value) {
                try {
                    ...
                    Preconditions.checkState(
                            tokens.size() == 1,
                            "Expected single token from '%', got %s",
                            value,
                            tokens.size());
        ...
        coreMap.put(TypedCalcConstants.SYMBOL_LIST, new SingleReturnCallable<TypedValue>() {
            ...
            public TypedValue call(Frame<TypedValue> frame, OptionalInt argumentsCount) {
                ...
                for (int i = 0; i < args; i++) result = domain.create(Cons.class, new Cons(stack.pop(), result));
        ...
        env.setGlobalSymbol(TypedCalcConstants.SYMBOL_SLICE, new BinaryFunction.WithFrame<TypedValue>() {
            ...
            public TypedValue call(Frame<TypedValue> frame, TypedValue target, TypedValue range) {
                ...
                if (slotSlice != null) return slotSlice.slice(target, range, frame);
        ...
        coreMap.put(TypedCalcConstants.SYMBOL_APPLY, new ICallable<TypedValue>() {
            ...
            public void call(Frame<TypedValue> frame, OptionalInt argumentsCount, OptionalInt returnsCount) {
                Preconditions
                        .checkArgument(argumentsCount.isPresent(), "'apply' cannot be called without argument count");
        ...
        env.setGlobalSymbol("fail", new ICallable<TypedValue>() {
            ...
            public void call(Frame<TypedValue> frame, OptionalInt argumentsCount, OptionalInt returnsCount) {
                if (argumentsCount.isPresent()) {
                    ...
                    Preconditions
                            .checkArgument(gotArgs == 0, "'fail' expects at most single argument, got %s", gotArgs);
                }
        ...
        env.setGlobalSymbol(TypedCalcConstants.SYMBOL_APPLYVAR, new ICallable<TypedValue>() {
            ...
            public void call(Frame<TypedValue> frame, OptionalInt argumentsCount, OptionalInt returnsCount) {
                Preconditions.checkArgument(
                        argumentsCount.isPresent(),
                        "'applyvar' cannot be called without argument count");
                final int args = argumentsCount.get();
        ...
        env.setGlobalSymbol("dir", new UnaryFunction.WithFrame<TypedValue>() {
            ...
            protected TypedValue call(Frame<TypedValue> frame, TypedValue value) {
                ...
                final List<TypedValue> wrappedResults = ImmutableList
                        .copyOf(Iterables.transform(sortedDir, domain.createWrappingTransformer(String.class)));
        ...
        final LetExpressionFactory letFactory = new LetExpressionFactory(
                domain,
                nullValue,
                colonOperator,
                assignOperator,
        ...
        final AltExpressionFactory altFactory = new AltExpressionFactory(
                domain,
                nullValue,
                colonOperator,
                assignOperator,
        ...
        class TypedValueCompilersFactory extends BasicCompilerMapFactory<TypedValue> {
            ...
            protected MappedCompilerState<TypedValue> createCompilerState(IAstParser<TypedValue> parser) {
                return new MappedCompilerState<TypedValue>(parser) {
                    ...
                    @Override
                    protected IExprNode<TypedValue> createDefaultSymbolNode(String symbol,
            ...
            protected void configureCompilerStateCommon(MappedCompilerState<TypedValue> compilerState,
                    Environment<TypedValue> environment) {
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_QUOTE,
                        new QuoteStateTransition.ForSymbol(domain, nullValue, valueParser));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_CODE,
                        new CodeStateTransition(domain, compilerState));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_IF,
                        ifFactory.createStateTransition(compilerState));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_LET,
                        letFactory.createLetStateTransition(compilerState));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_LETSEQ,
                        letFactory.createLetSeqStateTransition(compilerState));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_LETREC,
                        letFactory.createLetRecStateTransition(compilerState));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_DELAY,
                        delayFactory.createStateTransition(compilerState));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_MATCH,
                        matchFactory.createStateTransition(compilerState));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_AND_THEN,
                        new LazyArgsSymbolTransition(compilerState, domain, TypedCalcConstants.SYMBOL_AND_THEN));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_OR_ELSE,
                        new LazyArgsSymbolTransition(compilerState, domain, TypedCalcConstants.SYMBOL_OR_ELSE));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_NON_NULL,
                        new LazyArgsSymbolTransition(compilerState, domain, TypedCalcConstants.SYMBOL_NON_NULL));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_CONSTANT,
                        new ConstantSymbolStateTransition<TypedValue>(
                                compilerState,
                                environment,
                                TypedCalcConstants.SYMBOL_CONSTANT));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_ALT,
                        altFactory.createStateTransition(compilerState));
                compilerState.addStateTransition(
                        TypedCalcConstants.SYMBOL_DO,
                        doFactory.createStateTransition(compilerState));

                compilerState.addStateTransition(
                        TypedCalcConstants.MODIFIER_QUOTE,
                        new QuoteStateTransition.ForModifier(domain, nullValue, valueParser));
                compilerState.addStateTransition(
                        TypedCalcConstants.MODIFIER_OPERATOR_WRAP,
                        new CallableGetModifierTransition(domain, operators));
                compilerState.addStateTransition(
                        TypedCalcConstants.MODIFIER_INTERPOLATE,
                        new StringInterpolate.StringInterpolateModifier(domain, valuePrinter));
            }
            ...
            protected DefaultExprNodeFactory<TypedValue> createExprNodeFactory(IValueParser<TypedValue> valueParser) {
                return new MappedExprNodeFactory<TypedValue>(valueParser)
                        .addFactory(dotOperator, new IBinaryExprNodeFactory<TypedValue>() {
                            ...
                            @Override
                            public IExprNode<TypedValue> create(IExprNode<TypedValue> leftChild,
                                    IExprNode<TypedValue> rightChild) {
                        ...
                        .addFactory(
                                andOperator,
                                LazyBinaryOperatorNode
                                        .createFactory(andOperator, domain, TypedCalcConstants.SYMBOL_AND_THEN))
                        .addFactory(
                                orOperator,
                                LazyBinaryOperatorNode
                                        .createFactory(orOperator, domain, TypedCalcConstants.SYMBOL_OR_ELSE))
                        .addFactory(
                                nonNullOperator,
                                LazyBinaryOperatorNode
                                        .createFactory(nonNullOperator, domain, TypedCalcConstants.SYMBOL_NON_NULL))
                            ...
                            public IExprNode<TypedValue> create(IExprNode<TypedValue> leftChild,
                                ...
                                if (rightChild instanceof SquareBracketContainerNode) {
                                    ...
                                    if (leftChild instanceof SymbolGetNode) {
                                        ...
                                        final List<? extends IExprNode<TypedValue>> args = ImmutableList
                                                .copyOf(rightChild.getChildren());
                            ...
                            public IExprNode<TypedValue> create(IExprNode<TypedValue> leftChild,
                                ...
                                if (rightChild instanceof SquareBracketContainerNode) {
                                    ...
                                    return new ApplyCallNode.NullAware(varArgMarker, leftChild, rightChild, domain);
                                        ...
                                        "Operator '?' cannot be used with " + rightChild);
                            }
                        })
                        .addFactory(SquareBracketContainerNode.BRACKET_OPEN, new IBracketExprNodeFactory<TypedValue>() {
                            ...
                            public IExprNode<TypedValue> create(List<IExprNode<TypedValue>> children) {
                                Preconditions.checkState(
                                        children.size() == 1,
                                        "Expected only one expression in curly brackets");
            ...
            @Override
            protected ITokenStreamCompiler<TypedValue> createPostfixParser(final IValueParser<TypedValue> valueParser,
                    final OperatorDictionary<TypedValue> operators, Environment<TypedValue> env) {
                return addConstantEvaluatorState(
                        valueParser,
                        operators,
                        env,
                        new DefaultPostfixCompiler<TypedValue>(valueParser, operators))
                                .addModifierStateProvider(
                                        TypedCalcConstants.MODIFIER_QUOTE,
                                        new IStateProvider<TypedValue>() {
                                ...
                                .addBracketStateProvider(
                                        TypedCalcConstants.BRACKET_CODE,
                                        new IStateProvider<TypedValue>() {

                                            @Override
                                            public IPostfixCompilerState<TypedValue> createState() {
                                                final IExecutableListBuilder<TypedValue> listBuilder = new DefaultExecutableListBuilder<TypedValue>(
                                                        valueParser,
                                                        operators);
                                                return new CodePostfixCompilerState(
                                                        domain,
                                                        listBuilder,
                                                        TypedCalcConstants.BRACKET_CODE);
                                            }
                                ...
                                .addModifierStateProvider(
                                        BasicCompilerMapFactory.MODIFIER_SYMBOL_GET,
                                        new IStateProvider<TypedValue>() {
                                ...
                                .addModifierStateProvider(
                                        ...
                                        new IStateProvider<TypedValue>() {
                                            ...
                                            @Override
                                            public IPostfixCompilerState<TypedValue> createState() {
                                                return new StringInterpolate.StringInterpolatePostfixCompilerState(
                                                        domain,
                                                        valuePrinter);
                                            }
                                        });
        ...
        final Compilers<TypedValue, ExprType> compilers = new TypedValueCompilersFactory()
                .create(nullValue, valueParser, operators, env);
