...
public class TypedValue {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TypedValue) {
            ...
            return this.domain == other.domain && this.type == other.type && Objects.equal(this.value, other.value);
        }
    ...
    private ClassCastException castException(Class<?> expectedType, String location) {
        return new ClassCastException(
                String.format("Expected '%s' on %s, got %s", getClassName(expectedType), location, this));
    }
