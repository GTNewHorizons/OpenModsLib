...
public class LambdaExpressionFactory {
    ...
    private static IBindPattern extractPatternFromValue(TypedValue arg) {
        ...
        } else if (arg.is(IBindPattern.class)) {
    ...
    private List<IBindPattern> extractPatternFromValues(TypedValue argValues) {
        ...
        for (TypedValue arg : Cons.toIterable(argValues, nullValue)) args.add(extractPatternFromValue(arg));
        return args;
    }
    ...
    private class LambdaExpr extends BinaryOpNode<TypedValue> {
        ...
        public LambdaExpr(BinaryOperator<TypedValue> operator, IExprNode<TypedValue> left,
                IExprNode<TypedValue> right) {
