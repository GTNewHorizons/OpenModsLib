...
public class LibRandom {
                ...
                TypeUserdata.defaultMetaObject(domain)
                        .set(MetaObjectUtils.callableAdapter(new SimpleTypedFunction(domain) {
                            ...
                            public TypedValue create() {
                                return LibRandom.this.domain.create(
                                        RandomValue.class,
                                        RandomValue.INSTANCE,
    ...
    private MetaObject createRandomValueMetaobject(Random random) {
        ...
        return MetaObject.builder().set(MetaObjectUtils.typeConst(typeValue)).set(MetaObjectUtils.attrFromMap(members))
                .set(MetaObjectUtils.dirFromIterable(members.keySet())).build();
    }
