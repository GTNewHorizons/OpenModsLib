...
public class StringInterpolate {
        ...
        CONST {
            ...
            protected ITemplatePart createPart(final String contents) {
                return new ITemplatePart() {
                    ...
                    @Override
                    public void append(IValuePrinter<TypedValue> printer, SymbolMap<TypedValue> symbols,
    ...
    public static class TemplatePartInfo {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof TemplatePartInfo) {
                ...
                return Objects.equal(this.contents, other.contents) && this.type == other.type;
            }
    ...
    private static final TemplatePartInfo BRACKET_START_INFO = new TemplatePartInfo(
            TemplatePartType.BRACKET_START,
            "{");
            ...
            switch (state) {
                case OUTSIDE_QUOTE: {
                    if (ch == '{') {
                        ...
                        if (sectionStart < currentPos) parts.add(
                                new TemplatePartInfo(
                                        TemplatePartType.CONST,
                                        template.substring(sectionStart, currentPos)));
                    } else if (ch == '}') {
    ...
    private static class StringInterpolateExecutable implements IExecutable<TypedValue> {
        ...
        public StringInterpolateExecutable(TypeDomain domain, IValuePrinter<TypedValue> printer, String template) {
            ...
            this.parts = ImmutableList.copyOf(
                    Iterables.transform(parseTemplate(template), new Function<TemplatePartInfo, ITemplatePart>() {
        ...
        public void execute(Frame<TypedValue> frame) {
            ...
            for (ITemplatePart part : parts) part.append(printer, symbols, buffer);
