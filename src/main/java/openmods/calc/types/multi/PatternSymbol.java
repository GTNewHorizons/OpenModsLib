...
public class PatternSymbol {
    ...
    public static void register(final SymbolMap<TypedValue> coreMap, Environment<TypedValue> env) {
        ...
        final TypedValue patternType = domain.create(
                TypeUserdata.class,
                new TypeUserdata("pattern", IBindPattern.class),
                TypeUserdata.defaultMetaObject(domain)
                        .set(MetaObjectUtils.callableAdapter(new UnaryFunction.Direct<TypedValue>() {
                            ...
                            protected TypedValue call(TypedValue value) {
                                ...
                                final IBindPattern translatedPattern = patternTranslator
                                        .translatePattern(compiledPattern);
        ...
        domain.registerType(
                IBindPattern.class,
                "pattern",
                MetaObject.builder().set(MetaObjectUtils.typeConst(patternType)).build());
