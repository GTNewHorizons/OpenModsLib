...
public class ApplyCallNode implements IExprNode<TypedValue> {
    ...
    public ApplyCallNode(UnaryOperator<TypedValue> unpackMarker, IExprNode<TypedValue> target,
            IExprNode<TypedValue> args) {
        this.target = target;
        this.args = args;
    ...
    public static class NullAware extends ApplyCallNode {
        ...
        public NullAware(UnaryOperator<TypedValue> unpackMarker, IExprNode<TypedValue> target,
                IExprNode<TypedValue> args, TypeDomain domain) {
