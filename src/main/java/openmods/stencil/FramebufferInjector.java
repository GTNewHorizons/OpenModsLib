...
public class FramebufferInjector extends ClassVisitor {
    ...
    static {
        Type createRenderbufferType = Type
                .getMethodType(Type.VOID_TYPE, Type.INT_TYPE, Type.INT_TYPE, Type.INT_TYPE, Type.INT_TYPE);
        createRenderbufferMatcher = new MethodMatcher(
                openGlHelper,
                createRenderbufferType.getDescriptor(),
                "func_153186_a",
                "func_153186_a");
    }
    ...
    private class CreateFramebufferInjector extends MethodVisitor {
        ...
        public void visitLdcInsn(Object cst) {
            ...
            if ((cst instanceof Number)
                    && ((Number) cst).intValue() == 0x81A6 /* == 33190 == GL14.GL_DEPTH_COMPONENT24 */) {
