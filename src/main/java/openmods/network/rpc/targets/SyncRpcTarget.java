...
public abstract class SyncRpcTarget implements IRpcTarget {
    ...
    public static class SyncTileEntityRpcTarget extends SyncRpcTarget {
        ...
        public <P extends TileEntity & ISyncMapProvider & IRpcTargetProvider> SyncTileEntityRpcTarget(P provider,
    ...
    public static class SyncEntityRpcTarget extends SyncRpcTarget {
        ...
        public <P extends Entity & ISyncMapProvider & IRpcTargetProvider> SyncEntityRpcTarget(P provider,
                ISyncableObject object) {
            super(provider, object);
        }
    }
