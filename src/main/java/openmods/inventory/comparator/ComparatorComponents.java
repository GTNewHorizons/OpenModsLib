...
public class ComparatorComponents {
    ...
    public static final Ordering<ItemStack> ITEM_ID_COMPARATOR = Ordering.natural()
            .onResultOf(new Function<ItemStack, Integer>() {
    ...
    public static final Ordering<ItemStack> DAMAGE_COMPARATOR = Ordering.natural()
            .onResultOf(new Function<ItemStack, Integer>() {
    ...
    public static final Ordering<ItemStack> SIZE_COMPARATOR = Ordering.natural()
            .onResultOf(new Function<ItemStack, Integer>() {
