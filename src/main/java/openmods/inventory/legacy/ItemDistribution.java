...
public class ItemDistribution {
    ...
    public static boolean insertItemIntoInventory(IInventory inventory, ItemStack stack, ForgeDirection side,
            int intoSlot) {
        return insertItemIntoInventory(inventory, stack, side, intoSlot, true);
    }

    public static boolean insertItemIntoInventory(IInventory inventory, ItemStack stack, ForgeDirection side,
            int intoSlot, boolean doMove) {
        return insertItemIntoInventory(inventory, stack, side, intoSlot, doMove, true);
    }

    public static boolean insertItemIntoInventory(IInventory inventory, ItemStack stack, ForgeDirection side,
            int intoSlot, boolean doMove, boolean canStack) {
    ...
    public static int moveItemInto(IInventory fromInventory, int fromSlot, CustomSinks.ICustomSink sink, int maxAmount,
    ...
    public static boolean insertItemInto(ItemStack stack, CustomSinks.ICustomSink sink, ForgeDirection intoSide,
            boolean doMove) {
    ...
    public static int moveItemInto(IInventory fromInventory, int fromSlot, IInventory target, int intoSlot,
            int maxAmount, ForgeDirection direction, boolean doMove) {
     ...
     * @param toInventory   the inventory you want the item to be put into. can be BC pipe or IInventory
     ...
     */
    public static int moveItemInto(IInventory fromInventory, int fromSlot, IInventory toInventory, int intoSlot,
            int maxAmount, ForgeDirection direction, boolean doMove, boolean canStack) {
        fromInventory = InventoryUtils.getInventory(fromInventory);
    ...
    public static int moveItemInto(IInventory fromInventory, int fromSlot, TileEntity te, ForgeDirection intoSide,
    ...
    public static int moveItemsFromOneOfSides(TileEntity te, IInventory inv, int maxAmount, int intoSlot,
            Iterable<ForgeDirection> sides, boolean randomize) {
    ...
    public static int moveItemsFromOneOfSides(TileEntity te, IInventory inv, ItemStack filterStack, int maxAmount,
            int intoSlot, Iterable<ForgeDirection> sides, boolean randomize) {
        if (randomize) {
        ...
        for (ForgeDirection dir : sides) {
            ...
            if (tileOnSurface instanceof IInventory) {
                ...
                Set<Integer> slots = filterStack == null ? InventoryUtils.getAllSlots(neighbor)
                        : InventoryUtils.getAllSlotsWithStack(neighbor, filterStack);
                for (Integer slot : slots) {
                    int moved = moveItemInto(
                            neighbor,
                            slot,
                            ourInventory,
                            intoSlot,
