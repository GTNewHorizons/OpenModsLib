...
@Mod(
        ...
        name = OpenMods.MODID,
        version = Mods.OPEN_MODS_LIB_VERSION,
        dependencies = "required-after:OpenModsCore",
        guiFactory = "openmods.GuiFactory")
public class OpenMods {
    ...
    public void preInit(FMLPreInitializationEvent evt) {
        ...
        RpcCallDispatcher.INSTANCE.startRegistration().registerInterface(IRpcDirectionBitMap.class)
                .registerInterface(IRpcIntBitMap.class).registerTargetWrapper(EntityRpcTarget.class)
