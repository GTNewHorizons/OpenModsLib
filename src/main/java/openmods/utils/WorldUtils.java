...
public class WorldUtils {
    ...
    public static <T extends Entity> List<T> getEntitiesWithinAABB(World world, Class<? extends T> cls,
            AxisAlignedBB aabb) {
    ...
    @SuppressWarnings("unchecked")
    public static <T extends Entity> List<T> getEntitiesWithinAABB(World world, Class<? extends T> cls,
            AxisAlignedBB aabb, IEntitySelector selector) {
    ...
    @SuppressWarnings("unchecked")
    public static List<Entity> getEntitiesWithinAABB(Entity excluding, World world, AxisAlignedBB aabb,
    ...
    public static World getWorld(int dimensionId) {
        ...
        if (FMLCommonHandler.instance().getEffectiveSide() == Side.SERVER) {
            ...
            Preconditions.checkArgument(
                    result.provider.dimensionId == dimensionId,
                    "Invalid client dimension id %s",
                    dimensionId);
        }
