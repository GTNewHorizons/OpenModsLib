...
public class EntityUtils {
    ...
    public static Vec3 getPredictedPosition(Entity entity) {
        return getCurrentPosition(entity).addVector(entity.motionX, entity.motionY, entity.motionZ);
    }
    ...
    public static MovingObjectPosition raytraceEntity(Entity entity) {
        ...
        return entity.worldObj
                .func_147447_a(getCurrentPosition(entity), getPredictedPosition(entity), false, true, false);
    }

    private static final FieldAccess<Boolean> ENTITY_INVULNERABLE = FieldAccess
            .create(Entity.class, "invulnerable", "field_83001_bt");
