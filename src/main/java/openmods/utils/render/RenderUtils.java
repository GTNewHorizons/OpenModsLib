...
public class RenderUtils {
    ...
    /**
     * Please! For the love of sanity. Do not store this instance ANYWHERE! If you set it to a TE or Entity, Please
     * remove it after you're done! THANK YOU!
     *
    ...
    public static void renderInventoryBlock(RenderBlocks renderer, Block block, int metadata, int colorMultiplier,
            Set<ForgeDirection> enabledSides) {
    ...
    public static void renderInventoryBlockNoBounds(RenderBlocks renderer, Block block, int metadata,
            int colorMultiplier, Set<ForgeDirection> enabledSides) {
