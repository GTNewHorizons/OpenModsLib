...
public class PaintUtils {
    ...
    protected PaintUtils() {
        ...
        if (Loader.isModLoaded(Mods.TINKERSCONSTRUCT)) {
            addBlocksForMod(Mods.TINKERSCONSTRUCT, "GlassBlock", "decoration.multibrick", "decoration.multibrickfancy");
        }
        if (Loader.isModLoaded(Mods.EXTRAUTILITIES)) {
            addBlocksForMod(Mods.EXTRAUTILITIES, "greenScreen", "extrautils:decor");
        }
        if (Loader.isModLoaded(Mods.BIOMESOPLENTY)) {
            addBlocksForMod(Mods.BIOMESOPLENTY, "bop.planks");
        }
    }
