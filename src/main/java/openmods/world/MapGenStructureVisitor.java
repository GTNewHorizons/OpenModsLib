...
public class MapGenStructureVisitor extends ClassVisitor {
    ...
    private class FixerMethodVisitor extends MethodVisitor {
        ...
        /*
         * Default compilator usually creates: checkcast class net/minecraft/world/gen/structure/StructureStart astore X
         * aload X We use that to get id of local variable that stores 'structurestart'
         */
        ...
        /*
         * Here we are transforming condition if (structurestart.isSizeableStructure()) to if
         * (structurestart.isSizeableStructure() && !structurestart.getComponents().isEmpty()) Again, we assume that
         * compilator places IFEQ jump just after calling isSizeableStructure from first expression. We can then reuse
         * label for second part
         */
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean intf) {
            ...
            if (opcode == Opcodes.INVOKEVIRTUAL && owner.equals(structureStartCls.name())
                    && markerMethod.match(name, desc)) {
        ...
        public void visitJumpInsn(int opcode, Label label) {
            ...
            if (markerMethodFound && localVarId != null && opcode == Opcodes.IFEQ) {
                ...
                super.visitMethodInsn(
                        ...
                        structureStartCls.name(),
                        getComponentsMethodName,
